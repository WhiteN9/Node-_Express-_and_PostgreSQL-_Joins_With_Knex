...
async function listAverageRatingByOwner(req, res, next) {
  const averageRatingByOwners = await service.listAverageRatingByOwner();
  //  console.log(averageRatingByOwners)
  averageRatingByOwners.forEach((element) => {
    return (element.avg = parseFloat(element.avg));
  });
  //  console.log(averageRatingByOwners)
  res.json({ data: averageRatingByOwners });
}
...
async function list(req, res) {
  //   const data = { data: await service.list() }
  //   console.log(data)
